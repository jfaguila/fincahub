...
const plans = [
  {
    ...
    cta: "Empezar ahora",
    note: "Ideal para empezar · Sin permanencia",
  },
  {
    name: "Asistente WhatsApp",
    price: "67",
    setup: "597 € (pago único)",
    highlight: false,
    features: [
    ...
    cta: "Solicitar info",
    note: "Vende 24/7 por WhatsApp · Sin permanencia",
  },
  {
    name: "Recepcionista Virtual",
    price: "97",
    setup: "897 € (pago único)",
    highlight: false,
    features: [
      "Recepcionista telefónica con IA",
      "100 minutos de llamadas/mes",
      "Agenda citas automáticamente",
      "Integración con calendario",
      "Cualificación y filtrado de leads",
      "Soporte prioritario",
    ],
    cta: "Solicitar demo",
    note: "Tu recepcionista 24/7 · Sin permanencia",
  },
  {
    name: "Pack Cobertura Total",
    price: "147",
    setup: "1.297 € (pago único)",
    highlight: true,
    features: [
      "Recepcionista Virtual + WhatsApp",
      "100 min llamadas + 1.500 conv/mes",
    ...
    cta: "Solicitar demo",
    note: "MÁS POPULAR · Ahorro de 197€ · Sin permanencia",
  },
];
